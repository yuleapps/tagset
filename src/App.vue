...
const PROLIFIC_WRITERS = [
	'alley_skywalker', 'arbitrarily', 'arithanas', 'assimbya', 'astrokath', 'beatrice_otter', 'betony', 'brutti_ma_buoni', 'carolinecrane', 'chibifukurou', 'chicafrom3', 'chokolattejedi', 'cjmarlowe', 'damkianna', 'donutsweeper', 'escritoireazul', 'esteliel', 'estirose', 'eustaciavye', 'executrix', 'fabrisse', 'finch', 'flipflop_diva', 'fresne', 'greerwatson', 'halotolerant', 'haywire', 'htbthomas', 'innie', 'joanne_c', 'kalypsobean', 'karanguni', 'katayla', 'keerawa', 'laughingpineapple', 'lightningwaltz', 'longwhitecoats', 'mardia', 'marks', 'measured_words', 'merryghoul', 'miss_m', 'misura', 'mithen', 'mithrigil', 'nary', 'nightsmistress', 'nomadicwriter', 'plinys', 'primeideal', 'prosodiical', 'psychomachia', 'russian_blue', 'sadlikeknives', 'sarren', 'settiai', 'sevenofspade', 'skazka', 'spock', 'sumi', 'the_alchemist', 'thedevilchicken', 'tlvop', 'tuesday', 'voleuse', 'yhlee (etothey)'
]; 
